    ...
    >
      ...
      <CalculatorContentSection
        ...
        faqs={[
            ...
            { question: "Can I run this in the background or if my screen locks?", answer: "Most modern browsers often 'throttle' or slow down JavaScript timers in inactive tabs or when the device screen is locked to save system resources and battery life. For critical, long-duration timing, it is highly recommended to keep the tab open and active to ensure the stopwatch continues to run accurately." },
