  ...
  return (
    ...
    >
        ...
        <CalculatorContentSection
          ...
          examples={[
            { title: "Short two-sentence test", description: "\"Hello world! This is a test.\" counts 6 words, 28 characters and 2 sentences.", steps: ["Words: split on whitespace gives Hello(1) world!(2) This(3) is(4) a(5) test.(6) = 6 words.", "Characters: full length including spaces and punctuation = 28; without spaces 28 − 5 = 23.", "Sentences: split on . ! ? gives 2 non-empty parts; paragraphs = 1; reading time = ceil(6 / 200) = 1 min."] },
            { title: "450-word blog section", description: "A 450-word draft section reads in about 3 minutes and speaks in about 3.5 minutes.", steps: ["Reading time: ceil(450 / 200) = ceil(2.25) = 3 min at 200 words per minute.", "Speaking time: 450 / 130 = 3.46 min, so about 3.5 minutes at 130 words per minute.", "Characters estimate: at ~5.5 characters per word plus spaces, expect roughly 450 × 6.5 = 2,925 characters."] },
          ]}
          faqs={[
            ...
            { question: "What does \"Hello world! This is a test.\" count as?", answer: "It counts 6 words (Hello, world!, This, is, a, test.), 28 characters with spaces and 23 without (5 spaces), 2 sentences split on ! and ., 1 paragraph, and ceil(6 / 200) = 1 minute of reading time." },
            { question: "How long does it take to read or speak a 1,200-word essay?", answer: "Reading at 200 words per minute gives ceil(1,200 / 200) = 6 minutes. Speaking at 130 words per minute gives 1,200 / 130 = 9.2 minutes, so plan about 9-10 minutes with pauses." }
          ]}
        />
    </CalculatorLayout>
  );
