...
export const allCalculators = [...calculatorTools, ...educationalTools,
  ...
  },
  {
  ...
  },
   {
    ...
    icon: Repeat,
    href: "/financial-calculators/currency-converter",
  ...
  },
  {
    ...
    icon: Divide,
    href: "/math-calculators/fraction-calculator",
  ...
  },
  {
    ...
    icon: Repeat,
    href: "/other-calculators/conversion-calculator",
    imageId: "conversion-calculator",
    category: "other",
    implemented: true,
  },
  {
