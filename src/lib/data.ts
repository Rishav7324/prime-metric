...
export const financialCalculatorsData: Omit<CalculatorType, 'icon'>[] = [
  { id: "mortgage", name: "Mortgage Calculator", description: "Calculate monthly mortgage payments", category: "financial", path: "/financial-calculators/mortgage-calculator", implemented: false },
  ...
  { id: "currency", name: "Currency Calculator", description: "Convert between currencies", category: "financial", path: "/financial-calculators/currency-converter", implemented: true },
  ...
  { id: "roi", name: "ROI Calculator", description: "Calculate return on investment", category: "financial", path: "/financial-calculators/roi-calculator", implemented: false },
  { id: "sip", name: "SIP Calculator", description: "Systematic Investment Plan calculator", category: "financial", path: "/financial-calculators/sip-calculator", implemented: false },
  { id: "swp", name: "SWP Calculator", description: "Systematic Withdrawal Plan calculator", category: "financial", path: "/financial-calculators/swp-calculator", implemented: false },
  { id: "payment", name: "Payment Calculator", description: "Calculate payment schedules", category: "financial", path: "/financial-calculators/payment-calculator", implemented: false },
  ...
  { id: "salary", name: "Salary Calculator", description: "Calculate salary components", category: "financial", path: "/financial-calculators/salary-calculator", implemented: false },
  { id: "interest", name: "Interest Calculator", description: "Calculate simple/compound interest", category: "financial", path: "/financial-calculators/interest-calculator", implemented: false },
  { id: "simple-interest", name: "Simple Interest Calculator", description: "Calculate simple interest", category: "financial", path: "/financial-calculators/simple-interest-calculator", implemented: false },
  ...
  { id: "rent", name: "Rent Calculator", description: "Calculate rental costs", category: "financial", path: "/financial-calculators/rent-calculator", implemented: false },
  ...
  { id: "retirement", name: "Retirement Calculator", description: "Plan for retirement", category: "financial", path: "/financial-calculators/retirement-calculator", implemented: false },
  ...
  { id: "401k", name: "401K Calculator", description: "Calculate 401K growth", category: "financial", path: "/financial-calculators/401k-calculator", implemented: false },
  { id: "sales-tax", name: "Sales Tax Calculator", description: "Calculate sales tax", category: "financial", path: "/financial-calculators/sales-tax-calculator", implemented: false },
  { id: "savings", name: "Savings Calculator", description: "Calculate savings growth", category: "financial", path: "/financial-calculators/savings-calculator", implemented: false },
...
export const healthCalculatorsData: Omit<CalculatorType, 'icon'>[] = [
  ...
  { id: "tdee", name: "TDEE Calculator", description: "Total Daily Energy Expenditure", category: "health", path: "/health-calculators/tdee-calculator", implemented: false },
  { id: "macro", name: "Macro Calculator", description: "Calculate macronutrient needs", category: "health", path: "/health-calculators/macro-calculator", implemented: false },
  { id: "protein", name: "Protein Calculator", description: "Calculate protein needs", category: "health", path: "/health-calculators/protein-calculator", implemented: false },
  ...
  { id: "pregnancy", name: "Pregnancy Calculator", description: "Track pregnancy timeline", category: "health", path: "/health-calculators/pregnancy-calculator", implemented: false },
  { id: "pace", name: "Pace Calculator", description: "Calculate running pace", category: "health", path: "/health-calculators/pace-calculator", implemented: false },
...
export const mathCalculatorsData: Omit<CalculatorType, 'icon'>[] = [
  { id: "percentage", name: "Percentage Calculator", description: "Calculate percentages", category: "math", path: "/math-calculators/percentage-calculator", implemented: false },
  { id: "scientific", name: "Scientific Calculator", description: "Advanced scientific calculations", category: "math", path: "/math-calculators/scientific-calculator", implemented: false },
  ...
  { id: "volume", name: "Volume Calculator", description: "Calculate volume of shapes", category: "math", path: "/math-calculators/volume-calculator", implemented: false },
  { id: "slope", name: "Slope Calculator", description: "Calculate line slope", category: "math", path: "/math-calculators/slope-calculator", implemented: false },
  ...
  { id: "random-number", name: "Random Number Generator", description: "Generate random numbers", category: "math", path: "/math-calculators/random-number-generator", implemented: false },
  { id: "ratio", name: "Ratio Calculator", description: "Simplify ratios", category: "math", path: "/math-calculators/ratio-calculator", implemented: false },
  ...
  { id: "triangle", name: "Triangle Calculator", description: "Calculate triangle properties", category: "math", path: "/math-calculators/triangle-calculator", implemented: false },
  { id: "pythagorean", name: "Pythagorean Calculator", description: "Pythagorean theorem", category: "math", path: "/math-calculators/pythagorean-theorem-calculator", implemented: false },
  { id: "quadratic", name: "Quadratic Calculator", description: "Solve quadratic equations", category: "math", path: "/math-calculators/quadratic-formula-calculator", implemented: false },
  { id: "standard-deviation", name: "Standard Deviation Calculator", description: "Calculate standard deviation", category: "math", path: "/math-calculators/standard-deviation-calculator", implemented: false },
  ...
  { id: "percent-error", name: "Percent Error Calculator", description: "Calculate percent error", category: "math", path: "/math-calculators/percent-error-calculator", implemented: false },
...
export const otherCalculatorsData: Omit<CalculatorType, 'icon'>[] = [
  ...
  { id: "time", name: "Time Calculator", description: "Calculate time differences", category: "other", path: "/other-calculators/time-calculator", implemented: false },
  ...
  { id: "tip", name: "Tip Calculator", description: "Calculate tips and splits", category: "other", path: "/other-calculators/tip-calculator", implemented: false },
  ...
  { id: "password", name: "Password Generator", description: "Generate secure passwords", category: "other", path: "/other-calculators/password-generator", implemented: false },
  { id: "time-zone", name: "Time Zone Calculator", description: "Convert time zones", category: "other", path: "/other-calculators/time-zone-converter", implemented: false },
  ...
  { id: "speed", name: "Speed Calculator", description: "Calculate speed", category: "other", path: "/other-calculators/speed-calculator", implemented: false },
  ...
  { id: "mileage", name: "Mileage Calculator", description: "Calculate mileage", category: "other", path: "/other-calculators/mileage-calculator", implemented: false },
...
export const textToolsData: Omit<CalculatorType, 'icon'>[] = [
  ...
  { id: "invoice-generator", name: "Invoice Generator", description: "Create professional business invoices", category: "tools", path: "/tool/invoice-generator", implemented: false },
];
